...
//	: 제목, 참여감독 수, 참여배우 수, 관객수, 총점, 평점을 출력하는 기능
	...
	public Performance(String title, int dNum, int actNum, int audNum, 
			int score, String hNum) {
	...
	public void getInformation() {
		System.out.println("공연제목: " + getTitle() + " | 참여감독 수: " + getdNum()
		+ " | 참여배우 수: " + getActNum() + " | 관객수: " + getAudNum() + " | 총점: " + getScore()
		+ " | 평점: " + getGrade());
