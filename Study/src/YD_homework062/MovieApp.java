...
//	관객수, 총점과 평점은 입력되는 값에 따라 변동될 수 있습니다.	
	public static void main(String[] args) {
		Movie mInfo = new Movie("추격자", 7, 5, 0, 0); // 영화정보 담을 객체
		// mInfo.getInformation();
		// System.out.println(mInfo);
		// System.out.println("============================");
		Performance pInfo = new Performance("지킬엔하이드", 9, 10, 0, 0);
				...
				if (1 == cul) {
					while (true) {
						...
						if (score <= 5) {
							...
							mInfo = new Movie("추격자", 7, 5, t, score2);
							break; //
						} else {
					...
					while (true) {
						...
						if (score1 <= 5) {
							...
							pInfo = new Performance("지킬엔하이드", 9, 10, tt, score3);
							break;
						} else {
							System.out.println("최대 점수는 5점입니다.");
							System.out.println();
