...
public class ex04add {
	public static void main(String[] args) {
		...
		Lable: while (run) {
			// Lable = while문 종료. run이 true일 경우 실행됨. while문은 조건식이 true일 경우 계속해서 반복된다. 조건식이
			// false일때 종료됨
			...
			case 2:
				...
				for (int i = 0; i < studentNum; i++) { // 학생수는 0부터 입력값 까지 받겠다.
					System.out.print("점수[" + i + "]번 학생: " + scores); // 점수 실행문
